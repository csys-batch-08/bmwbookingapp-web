...
<body>
	...
	<nav
		...
		<div class="container">
			<a href="#" class="navbar-brand"> <!-- Logo Image --> <img
				...
				class="d-inline-block align-middle mr-2" id="imra"> <!-- Logo Text -->
			...
			<div id="navbarSupportedContent" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					...
					<form class="d-flex" action="search" method="post">
						<input class="form-control me-2" type="search" id="car" name="car"
							placeholder="Search" aria-label="Search" autocomplete="on"
							required>
	...
	<h1>
		<span style="color: red"> Welcome</span><span style="color: red">${sessionScope.username }</span>
	</h1>
	<div class="one">
		<table id="carproduct">
					...
					<c:forEach items="${listproduct}" var="carProduct">
						<td>
							<div class="car">
								...
								<strong><span>${carProduct.carName}</span></strong><br> <span><strong>FuelType</strong>
								...
								&nbsp;&nbsp;<span>: ${carProduct.carModel} </span><br> <span
									style="margin-left: 70px;"> <a
									href="SelectServlet?carId=${carProduct.carId}"><button
											class="btn btn-primary">view</button></a></span>
