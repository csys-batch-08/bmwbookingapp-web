	...
	<form action="addprice" method="post">
		<div class="one">
			...
			<label for="carid">Enter your carid:</label><br> <input
				type="text" name="carid" id="carid" required><br>
			<br> <label for="carname">Enter your carname:</label><br> <input
				type="text" name="carname" id="carname" required><br>
			<br> <label for="showroom_price">Enter your
				Exshowroom_price:</label><br> <input type="number"
				name="showroom_price" id="showroom_price" min="1" required><br>
			<label for="roadtax">Enter your Roadtax:</label><br> <input
				type="number" name="roadtax" id="roadtax" min="1" required><br>
			<br> <label for="insurance">Enter your insurance:</label><br>
			<input type="number" name="insurance" id="insurance" min="1" required><br>
			<br>
