...
<body>
	<div class="topnav" id="myTopnav">
		<a href="showss">ShowProduct</a> <a href="cartview">Cart</a> <a
			...
			href="updateWallet.jsp">Recharge Wallet</a> <a href="userbooking"
			class="active">Booking History</a>
	</div>
		...
		<tbody>
			<tr>
				...
				<c:forEach items="${listproduct}" var="booking">
					...
					<td style="width: 10%"><span><fmt:formatDate
								pattern="dd-MM-yyyy" value="${Expecteddate}" /></span></td>
